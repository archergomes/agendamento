...
<head>
    ...
    <title>Dashboard do Secretário - Hospital Matlhovele</title>
...
<body class="bg-gray-50">
    <div class="page-wrapper">
        ...
        <div id="sidebar-menu" class="sidebar bg-white shadow-lg">
            ...
            <nav class="sidebar-nav">
                <div class="main-menu">
                    <a href="/secretario/dashboard" class="block text-gray-700 hover:bg-blue-50 rounded">
                        <i class="fas fa-tachometer-alt"></i>
                        <span class="sidebar-text">Dashboard</span>
                    </a>
                    <a href="/secretario/agendamentos" class="block text-gray-700 hover:bg-blue-50 rounded">
                        <i class="fas fa-calendar-check"></i>
                        <span class="sidebar-text">Agendamentos</span>
                    </a>
                    <a href="/secretario/pacientes" class="block text-gray-700 hover:bg-blue-50 rounded">
                        <i class="fas fa-users"></i>
                        <span class="sidebar-text">Pacientes</span>
                    </a>
                    <a href="/secretario/medicos" class="block text-gray-700 hover:bg-blue-50 rounded">
        ...
        <header class="bg-blue-600 text-white shadow-lg">
            <div class="container mx-auto px-4 py-3 flex header-content">
        ...
        <main class="main-content">
            <div class="container mx-auto px-4 py-8">
                <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Dashboard do Secretário</h2>

                    <!-- Metrics -->
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div class="bg-blue-50 p-4 rounded-lg">
                            <h3 class="text-lg font-medium text-gray-700">Consultas Hoje</h3>
                            <p id="today-appointments" class="text-2xl font-bold text-blue-600">0</p>
                        </div>
                        <div class="bg-blue-50 p-4 rounded-lg">
                            <h3 class="text-lg font-medium text-gray-700">Pendentes</h3>
                            <p id="pending-appointments" class="text-2xl font-bold text-blue-600">0</p>
                        </div>
                        <div class="bg-blue-50 p-4 rounded-lg">
                            <h3 class="text-lg font-medium text-gray-700">Total de Pacientes</h3>
                            <p id="total-patients" class="text-2xl font-bold text-blue-600">0</p>
                        </div>
                    </div>

                    <!-- Appointment List -->
                    <div>
                        <h3 class="text-lg font-medium text-gray-700 mb-4">Consultas Agendadas</h3>
        ...
        <div id="confirmation-modal">
            <div class="modal-content">
                ...
                <p class="mb-4">Deseja realmente cancelar este agendamento? Por favor, forneça um motivo.</p>
    ...
    <script>
        ...
        function updateMetrics() {
            ...
            const todayAppointments = bookedAppointments.filter(appt => appt.date === today && appt.status !== 'Cancelled').length;
            const pendingAppointments = bookedAppointments.filter(appt => appt.status === 'Pending').length;
            const totalPatients = Object.keys(userProfiles).length;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (!mobileMenuBtn || !sidebarMenu || !closeSidebarBtn || !toggleSidebarBtn || !mainContent) {
                console.error('Um ou mais elementos do DOM não foram encontrados:', {
                    mobileMenuBtn, sidebarMenu, closeSidebarBtn, toggleSidebarBtn, mainContent
                });
                return;
            }
            ...
            toggleSidebarBtn.addEventListener('click', (e) => {
                e.stopPropagation();
                if (window.innerWidth >= 768) {
                    console.log('Alternar sidebar desktop');
            ...
            document.addEventListener('click', (e) => {
                ...
                if (!isClickInsideSidebar && !isClickOnMenuBtn && isSidebarOpen && !isModalOpen && window.innerWidth < 768) {
                    console.log('Fechar sidebar por clique fora');
                    sidebarMenu.classList.remove('show');
                }
            });
            ...
            document.addEventListener('touchstart', (e) => {
                ...
                console.log('Touch start:', touchStartX, 'isTouchingSidebar:', isTouchingSidebar);
            });
            ...
            document.addEventListener('touchend', (e) => {
                ...
                if (window.innerWidth < 768) {
                    ...
                    console.log('Touch end:', touchEndX, 'deltaX:', deltaX);
                    if (!sidebarMenu.classList.contains('show') && touchStartX < 50 && deltaX > 50) {
                        console.log('Abrir sidebar por swipe');
                        sidebarMenu.classList.add('show');
                        sidebarMenu.classList.remove('collapsed');
                    }
                    if (isTouchingSidebar && sidebarMenu.classList.contains('show') && deltaX < -50) {
                        console.log('Fechar sidebar por swipe');
                        sidebarMenu.classList.remove('show');
                    }
                }
            });

            // Atualizar estado do sidebar em redimensionamento
            ...
            // Renderizar agendamentos e métricas
            updateMetrics();
            renderAppointments();
