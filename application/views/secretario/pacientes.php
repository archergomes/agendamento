    ...
    <head>
        ...
        <title>Pacientes - Secretário - Hospital Matlhovele</title>
        <meta name="description" content="Página de gerenciamento de pacientes para secretários do Hospital Público de Matlhovele">
    ...
    <body class="bg-gray-50">
            ...
            <div id="sidebar-menu" class="sidebar bg-white shadow-lg desktop">
                ...
                <nav class="sidebar-nav">
                    <div class="main-menu">
                        ...
                        <a href="<?php echo site_url('secretario/pacientes'); ?>" class="block text-gray-700 active">
                ...
                <div class="container mx-auto px-4 py-8">
                    ...
                    <div class="mb-8">
                        <div class="flex justify-between items-center mb-4">
                            <div>
                                <h2 class="text-2xl font-semibold text-gray-800 mb-2">Gestão de Pacientes</h2>
                                <p class="text-gray-600">Gerencie todos os pacientes do sistema</p>
                            </div>
                            <button onclick="abrirModalNovoPaciente()" class="action-btn success flex items-center gap-2">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <div class="quick-actions">
                            ...
                            <div class="quick-action-card" onclick="exportarPacientes()">
                                <div class="quick-action-icon">
                                    <i class="fas fa-download"></i>
                                </div>
                                <h4 class="font-semibold text-gray-800">Exportar Dados</h4>
                                <p class="text-sm text-gray-600 mt-2">Exportar lista de pacientes</p>
                            </div>
                            <div class="quick-action-card" onclick="window.location.href='<?php echo site_url('secretario/agendamentos'); ?>'">
                                ...
                                <p class="text-sm text-gray-600 mt-2">Criar agendamento rápido</p>
                            </div>
                            <div class="quick-action-card" onclick="gerarRelatorio()">
                                ...
                                <p class="text-sm text-gray-600 mt-2">Gerar relatório de pacientes</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="filter-section">
                        <div class="flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center">
                            ...
                            <div class="flex gap-2">
                                <button onclick="carregarPacientes()" class="action-btn secondary">
                    ...
                    <div class="bg-white rounded-lg shadow-md">
                        <div class="p-6">
                            ...
                            <!-- Card View (Mobile) -->
                            <div id="patients-cards" class="md:hidden">
                            ...
                            <div id="empty-state" class="empty-state hidden">
                                ...
                                <p class="text-gray-600 mb-4">Não há pacientes que correspondam aos seus critérios.</p>
                                <button onclick="abrirModalNovoPaciente()" class="action-btn success">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-input" id="input-nascimento" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-input" id="input-genero">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-textarea" id="input-observacoes" placeholder="Observações sobre o paciente..."></textarea>
                        </div>
                    </div>
        ...
        <div id="editar-paciente-modal" class="modal">
            <div class="modal-content">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-medium text-gray-700">Editar Paciente</h3>
                    <button onclick="fecharModalEditarPaciente()" class="text-gray-400 hover:text-gray-600">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <form id="form-editar-paciente">
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                <label class="form-label">Data de Nascimento *</label>
                                <input type="date" class="form-input" id="editar-nascimento" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                <label class="form-label">Gênero</label>
                                <select class="form-input" id="editar-genero">
                                    <option value="">Selecione</option>
                                    <option value="M">Masculino</option>
                                    <option value="F">Feminino</option>
                                    <option value="O">Outro</option>
                        ...
                        <div class="form-group">
                            <label class="form-label">Observações</label>
                            <textarea class="form-textarea" id="editar-observacoes" placeholder="Observações sobre o paciente..."></textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="flex gap-2 justify-end mt-6">
                        <button type="button" onclick="fecharModalEditarPaciente()" class="action-btn secondary">Cancelar</button>
        ...
        <div id="detalhes-paciente-modal" class="modal">
            <div class="modal-content" style="max-width: 600px;">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-medium text-gray-700">Detalhes do Paciente</h3>
                    <button onclick="fecharModalDetalhesPaciente()" class="text-gray-400 hover:text-gray-600">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <div id="detalhes-paciente-content">
        ...
        <script>
            ...
            async function loadKPIs() {
                try {
                    ...
                    document.getElementById('kpi-novos').textContent = kpis.novos;
                ...
                try {
                    ...
                    if (currentSearch) {
                        ...
                        pacientesFiltrados = pacientes.filter(paciente =>
                            ...
                            paciente.bi.toLowerCase().includes(searchLower) ||
            ...
            function renderPacientes(pacientes) {
                ...
                // Table View (Desktop)
                if (table) {
                    table.innerHTML = pacientes.map(paciente => {
                        const statusClass = paciente.status === 'active' ? 'status-active' : 'status-inactive';
                        const statusText = paciente.status === 'active' ? 'Ativo' : 'Inativo';

                        return `
                            <tr>
                                <td class="font-medium">${paciente.nome}</td>
                                <td>${paciente.telefone}</td>
                                <td>${paciente.bi}</td>
                                <td>${paciente.email || '-'}</td>
                                <td>${paciente.agendamentos}</td>
                                <td>
                                    <span class="status-badge ${statusClass}">${statusText}</span>
                                </td>
                                <td>
                                    <div class="flex gap-2 action-buttons">
                                        <button class="action-btn text-sm" onclick="verDetalhesPaciente(${paciente.id})">
                                            <i class="fas fa-eye mr-1"></i>
                                        </button>
                                        <button class="action-btn warning text-sm" onclick="editarPaciente(${paciente.id})">
                                            <i class="fas fa-edit mr-1"></i>
                                        </button>
                                        <button class="action-btn secondary text-sm" onclick="criarAgendamento(${paciente.id})">
                ...
                // Card View (Mobile)
                if (cards) {
                    cards.innerHTML = pacientes.map(paciente => {
                        const statusClass = paciente.status === 'active' ? 'status-active' : 'status-inactive';
                        const statusText = paciente.status === 'active' ? 'Ativo' : 'Inativo';
                        const cardClass = paciente.status === 'active' ? 'active' : 'inactive';

                        return `
                            <div class="patient-card ${cardClass}">
                                <div class="flex justify-between items-start mb-3">
                                    <div>
                                        <h4 class="font-semibold text-gray-800">${paciente.nome}</h4>
                                        <p class="text-sm text-gray-600">${paciente.bi}</p>
                                    </div>
                                    <span class="status-badge ${statusClass}">${statusText}</span>
                                </div>
                                <div class="grid grid-cols-2 gap-2 text-sm mb-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium">${paciente.agendamentos}</p>
                                    </div>
                                </div>
                                <div class="flex gap-2 action-buttons">
                                    <button class="action-btn flex-1 text-sm" onclick="verDetalhesPaciente(${paciente.id})">
                                        <i class="fas fa-eye mr-1"></i>Ver
                                    </button>
                                    <button class="action-btn warning flex-1 text-sm" onclick="editarPaciente(${paciente.id})">
                                        <i class="fas fa-edit mr-1"></i>Editar
                                    </button>
                                    <button class="action-btn secondary flex-1 text-sm" onclick="criarAgendamento(${paciente.id})">
            ...
            function editarPaciente(pacienteId) {
                ...
                // Carregar dados do paciente e abrir modal de edição
                carregarDadosEdicao(pacienteId);
                document.getElementById('editar-paciente-modal').classList.add('show');
            }

            function fecharModalEditarPaciente() {
                document.getElementById('editar-paciente-modal').classList.remove('show');
            ...
            function verDetalhesPaciente(pacienteId) {
                ...
                document.getElementById('detalhes-paciente-modal').classList.add('show');
            }

            function fecharModalDetalhesPaciente() {
                document.getElementById('detalhes-paciente-modal').classList.remove('show');
            }
            ...
            function gerarRelatorio() {
                showNotification('Gerando relatório de pacientes...', 'info');
                // Implementar geração de relatório
            }

            function criarAgendamento(pacienteId) {
                showNotification(`Redirecionando para criação de agendamento...`, 'info');
                // Redirecionar para página de agendamentos com paciente pré-selecionado
                // window.location.href = `<?php echo site_url('secretario/agendamentos/novo'); ?>?paciente=${pacienteId}`;
            }
            ...
            // Funções auxiliares
            function carregarDadosEdicao(pacienteId) {
                // Simulação de carregamento de dados para edição
                // Em produção, buscar dados do paciente da API
                const paciente = {
                    id: pacienteId,
                    nome: 'Maria Santos',
                    telefone: '+258 84 123 4567',
                ...
                document.getElementById('editar-nome').value = paciente.nome;
                document.getElementById('editar-nascimento').value = paciente.nascimento;
                document.getElementById('editar-telefone').value = paciente.telefone;
                document.getElementById('editar-email').value = paciente.email;
                document.getElementById('editar-bi').value = paciente.bi;
                document.getElementById('editar-genero').value = paciente.genero;
                document.getElementById('editar-endereco').value = paciente.endereco;
                document.getElementById('editar-observacoes').value = paciente.observacoes;
                document.getElementById('editar-status').value = paciente.status;
            }

            function carregarDetalhesPaciente(pacienteId) {
                ...
                const content = document.getElementById('detalhes-paciente-content');
                content.innerHTML = `
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="form-label">Data de Nascimento</label>
                                <p class="font-medium">${formatDate(paciente.nascimento)} (${paciente.idade} anos)</p>
                            </div>
                            <div>
                                <label class="form-label">Gênero</label>
                                <p class="font-medium">${paciente.genero}</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                            ...
                            <div>
                                <label class="form-label">Email</label>
                                <p class="font-medium">${paciente.email || 'Não informado'}</p>
                            </div>
                        </div>
                        <div>
                            <label class="form-label">Endereço</label>
                            <p class="font-medium">${paciente.endereco || 'Não informado'}</p>
                        </div>
                        <div>
                            <label class="form-label">Observações</label>
                            <p class="font-medium">${paciente.observacoes || 'Nenhuma observação'}</p>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="form-label">Status</label>
                                <p class="font-medium"><span class="status-badge status-active">${paciente.status}</span></p>
                            </div>
                            <div>
                                <label class="form-label">Total de Agendamentos</label>
                                <p class="font-medium">${paciente.agendamentos}</p>
                            </div>
                            <div>
                                <label class="form-label">Data de Cadastro</label>
                                <p class="font-medium">${paciente.data_cadastro}</p>
                            </div>
                        </div>
                    </div>
                `;
            ...
            function setupEventListeners() {
                ...
                if (formEditarPaciente) {
                    formEditarPaciente.addEventListener('submit', function(e) {
                        e.preventDefault();
                        // Simulação de edição de paciente
